...
const Board = ({ children }) => {
    ...
    return <>
        ...
        <div className="grid grid-cols-3 gap-2 w-[240px] my-3">
        ...
        <button onClick={ResetGame} class="h-10 px-6 font-semibold rounded-md bg-black text-white my-5">Chơi lại</button>
        <button onClick={UndoGame} class="h-10 px-6 font-semibold rounded-md bg-black text-white my-5">Undo</button>
    </>
}
